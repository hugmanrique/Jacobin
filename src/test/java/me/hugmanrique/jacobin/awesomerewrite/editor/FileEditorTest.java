...
import static me.hugmanrique.jacobin.awesomerewrite.editor.TestFileEditorUtils.createTempFile;
...
public class FileEditorTest {
    ...
    public void testWriteAndRead() throws IOException {
        File tempFile = createTempFile("writeRead");
    ...
    public void testBackAndRead() throws IOException {
        File tempFile = createTempFile("backAndRead");
